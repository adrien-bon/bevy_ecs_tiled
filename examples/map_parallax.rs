...
fn main() {
    App::new()
        ...
        // .add_systems(Update, (update_instructions, demonstrate_parallax_setup))
        .run();
}

fn startup(mut commands: Commands, asset_server: Res<AssetServer>) {
    // Spawn a 2D camera and save its entity reference on the map entity using the
    // `TilemapParallaxCamera` component
